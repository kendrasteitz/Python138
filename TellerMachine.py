...
class TellerMachine():
    ...
    def accounts(self):
        win = GraphWin("Automatic Teller Machine (ATM)", 550, 375)
        win.setBackground("gray")
        win.setCoords(0, 0, 30, 20)
        banner = Text(Point(15, 17), "Welcome to Falcon Bank")
        banner.setSize(24)
        ...
        withdraw = Button(win, Point(21, 9), 11, 3, "Withdrawal")
        withdraw.activate()
        deposit = Button(win, Point(21, 4), 11, 3, "Deposit")
        deposit.activate()
